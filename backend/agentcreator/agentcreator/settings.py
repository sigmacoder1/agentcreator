"""
Django settings for agentcreator project.
...
SECRET_KEY = 'django-insecure-2)nl81f(s3!8+3_6##l^f*sz_y7=r3+m)gz5hxwi=pfjoj_u38'
...
WSGI_APPLICATION = 'agentcreator.wsgi.application'
